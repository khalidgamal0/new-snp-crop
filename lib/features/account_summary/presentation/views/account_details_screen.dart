      ...
      child: Scaffold(
        ...
        body: BlocBuilder<SplashCubit, SplashState>(
          builder: (context, state) {
            ...
            return state is AccountDetailsLoading
                ? Center(
                    child: CupertinoActivityIndicator(
                    color: AppColors.secondary,
                  ))
                : state is AccountDetailsSuccess
                    ? SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            AccountItem(
                              name:
                                  cubit.accountDetailsModelApi?.data?.accountName ??
                                      'نشط',
                              id: cubit.accountDetailsModelApi?.data
                                      ?.accountNumber ??
                                  '27400000535107',
                              balance:
                                  cubit.accountDetailsModelApi?.data?.balance ??
                                      '5.94',
                            ),
                            verticalSpacer(16),
                            Padding(
                            ...
                            AccountDetailsItem(
                              name: 'إسم الحساب ',
                              value: cubit.accountDetailsModelApi?.data
                                      ?.accountName ??
                            ...
                            AccountDetailsItem(
                              name: 'الحاله',
                              value:
                                  cubit.accountDetailsModelApi?.data?.status ??
                                      'نشط',
                            ),
                            AccountDetailsItem(
                              name: 'رقم حساب الأبيان',
                              value: cubit.accountDetailsModelApi?.data?.iban ??
                                  'SA361000000140012795200',
                            ),
                            AccountDetailsItem(
                              name: 'الرصيد',
                              value:
                                  'SAR ${cubit.accountDetailsModelApi?.data?.balance ?? '4.32'}',
                            ),
                            AccountDetailsItem(
                              name: 'الرصيد الحالي',
                              value:
                            ...
                            AccountDetailsItem(
                              ...
                              value:
                                  'SAR ${cubit.accountDetailsModelApi?.data?.overdraftLimit ?? '0.00'}',
                            ),
                            AccountDetailsItem(
                              isFinal: true,
                                    ...
                                    onTap: () {
                                      ...
                                      goToWidget(
                                        ...
                                        accountId: cubit.accountDetailsModelApi
                                                ...
                                                .toString() ??
                                            '',
                                        name: cubit.accountDetailsModelApi?.data
                                                ?.accountName
                                                .toString() ??
                                            '',
                                        number: cubit.accountDetailsModelApi
                                                ?.data?.accountNumber
                                                .toString() ??
                                            '27400000535107',
                                        balance: cubit.accountDetailsModelApi
                                                ?.data?.balance
                                                .toString() ??
                                            '5.94',
                                      ));
                            ...
                            verticalSpacer(16),
                            if (cubit.accountDetailsModelApi?.data
                                    ?.lastTransactions?.isNotEmpty ==
                                true)
                              ListView.builder(
                                shrinkWrap: true,
                                ...
                                itemBuilder: (context, index) =>
                                  ...
                                  transactionModel: cubit.accountDetailsModelApi
                                      ?.data?.lastTransactions?[index],
                                ),
                                itemCount: cubit.accountDetailsModelApi?.data
